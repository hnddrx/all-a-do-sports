...
import { Camera, Sun, Moon, Menu } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className={`text-2xl font-light tracking-tight ${theme.text}`}>Aerial Stories</h1>
              <p className={`text-xs ${theme.subtext} tracking-wide hidden sm:block`}>Professional Drone Photography</p>
            </div>
          </div>
